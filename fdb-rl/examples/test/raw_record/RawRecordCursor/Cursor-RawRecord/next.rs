...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let tests = vec![
        ...
        Trial::test(
            "cursor_subspace_abnormal_reverse_state_read_last_split",
            cursor_subspace_abnormal_reverse_state_read_last_split,
        ),
        Trial::test(
            "cursor_subspace_abnormal_forward_state_raw_record_available",
            cursor_subspace_abnormal_forward_state_raw_record_available,
        ),
        Trial::test(
            "cursor_subspace_abnormal_reverse_state_raw_record_available",
            cursor_subspace_abnormal_reverse_state_raw_record_available,
        ),
    ];
            ...
            fdb_database
                .run(|tr| async move {
                    ...
                    // test.
                    {
                        // Create a record with a missing key-value.
                        //
                        // `next_split_index` will detect the missing
                        // key-value.
                        //
                        // ```
                        // ("sub", "space", "abnormal", "07", "very_long", -1)
                        // ("sub", "space", "abnormal", "07", "very_long",  0)
                        // ("sub", "space", "abnormal", "07", "very_long",  1) missing
                        // ("sub", "space", "abnormal", "07", "very_long",  2)
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "07");
                        ...
                        // Create a record with a missing key-value.
                        //
                        // `next_split_index` will *not* be able to
                        // detect the missing key-value. `data_splits`
                        // in record header will be able to detect the
                        // mismatch and cause an error.
                        //
                        // ```
                        // ("sub", "space", "abnormal", "08", "very_long", -1)
                        // ("sub", "space", "abnormal", "08", "very_long",  0)
                        // ("sub", "space", "abnormal", "08", "very_long",  1)
                        // ("sub", "space", "abnormal", "08", "very_long",  2) missing
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "08");
                            ...
                            // Clear the key `("sub", "space",
                            // "abnormal", "08", "very_long", 2)`.
                            tr.clear(Key::from(
                                {
                                    let tup: (&str, &str, &str, &str, &str, i8) =
                                        ("sub", "space", "abnormal", "08", "very_long", 2);
                        ...
                        //
                        // ```
                        // ("sub", "space", "abnormal", "09", "medium", -1)
                        // ("sub", "space", "abnormal", "09", "medium",  0) missing
                        // ("sub", "space", "abnormal", "09", "short",  -1) missing
                        // ("sub", "space", "abnormal", "09", "short",   0)
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "09");
                            ...
                            // Clear the key `("sub", "space",
                            // "abnormal", "09", "medium", 0)`.
                            tr.clear(Key::from(
                                {
                                    let tup: (&str, &str, &str, &str, &str, i8) =
                                        ("sub", "space", "abnormal", "09", "medium", 0);
                    ...
                    // test.
                    //
                    // The test case for this is very similar to test
                    // case for
                    // `cursor_subspace_abnormal_forward_state_initiate_record_version_read`.
                    //
                    // The main difference is that we now have a valid
                    // record before the error is encountered.
                    {
                        // Create a valid record followed by a
                        // key-value with an error.
                        //
                        // ```
                        // ("sub", "space", "abnormal", "10", "long", -1)
                        // ("sub", "space", "abnormal", "10", "long",  0)
                        // ("sub", "space", "abnormal", "10", "long",  1)
                        // ("sub", "space", "abnormal", "10", "medium", "non_number")
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "10");
                            ...
                            let key = Key::from(
                                {
                                    let tup: (&str, &str, &str, &str, &str, &str) =
                                        ("sub", "space", "abnormal", "10", "medium", "non_number");
                                    ...
                                    t.push_back::<String>(tup.3.to_string());
                                    t.push_back::<String>(tup.4.to_string());
                                    t.push_back::<String>(tup.5.to_string());
                                    t
                                }
                                .pack(),
                            );
                        ...
                        //
                        // ```
                        // ("sub", "space", "abnormal", "11", "long", -1)
                        // ("sub", "space", "abnormal", "11", "long",  0)
                        // ("sub", "space", "abnormal", "11", "long",  1)
                        // ("sub", "space", "abnormal", "11", "medium", 0)
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "11");
                    ...
                    {
                        // Create a valid record followed by a
                        // key-value with an error (when read from the
                        // reverse).
                        //
                        // ```
                        // ("sub", "space", "abnormal", "12", "short", "non_number")
                        // ("sub", "space", "abnormal", "12", "very_long", -1)
                        // ("sub", "space", "abnormal", "12", "very_long",  0)
                        // ("sub", "space", "abnormal", "12", "very_long",  1)
                        // ("sub", "space", "abnormal", "12", "very_long",  2)
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "12");
                        ...
                        //
                        // ```
                        // ("sub", "space", "abnormal", "13", "short", -1)
                        // ("sub", "space", "abnormal", "13", "very_long", -1)
                        // ("sub", "space", "abnormal", "13", "very_long",  0)
                        // ("sub", "space", "abnormal", "13", "very_long",  1)
                        // ("sub", "space", "abnormal", "13", "very_long",  2)
                        // ```
                        {
                            let subspace = Subspace::new(Bytes::new()).subspace(&{
                                let tup: (&str, &str, &str, &str) =
                                    ("sub", "space", "abnormal", "13");
...
fn cursor_subspace_abnormal_reverse_state_read_last_split() -> Result<(), Failed> {
    let rt = Builder::new_current_thread().build()?;
...
fn cursor_subspace_abnormal_forward_state_raw_record_available() -> Result<(), Failed> {
    let rt = Builder::new_current_thread().build()?;
    ...
    rt.block_on({
        ...
        async move {
            fdb_database
                .read(|tr| async move {
                    // Valid record followed by a key-value with an
                    // error.
                    //
                    // ```
                    // ("sub", "space", "abnormal", "10", "long", -1)
...
fn cursor_subspace_abnormal_reverse_state_raw_record_available() -> Result<(), Failed> {
    let rt = Builder::new_current_thread().build()?;
    ...
    rt.block_on({
        ...
        async move {
            fdb_database
                .read(|tr| async move {
                    // Valid record followed by a key-value with an
                    // error (when read from the reverse).
                    //
                    // ```
                    // ("sub", "space", "abnormal", "12", "short", "non_number")
                    // ("sub", "space", "abnormal", "12", "very_long", -1)
                    ...
                    // Valid record followed by a key-value with
                    // an error (when read from the reverse).
                    //
                    // ```
                    // ("sub", "space", "abnormal", "13", "short", -1)
                    // ("sub", "space", "abnormal", "13", "very_long", -1)
